...
export const WEAPONS = {
  ...
  hawk: {
    ...
    range: 160,
    speedMult: 0.95,
    blurb: "Bolt-action sniper. Fast scope-in, tiny magazine, and one-shot body precision.",
    stat: 96,
    statLabel: "Quick-scope power",
  },
  backstop: {
    id: "backstop",
    name: "Backstop",
...
export const AGENTS = [
  ...
  },
  {
    ...
    name: "Vanta",
    role: "Duelist",
    bio: "A redline speedster who turns reload windows into sudden entries and bright lightning-fast pressure.",
    profile: "Aggressive duelist tuned for sprint entries, quick reload resets, and clean pressure through simple movement.",
    ability: {
      id: "surge",
      name: "Redline Surge",
      key: "Q",
      cooldownMs: 18000,
      durationMs: 3500,
      blurb: "Instantly reload, spark a speed trail, and gain +40% move speed for 3.5s.",
    },
  },
  {
    id: "kestrel",
